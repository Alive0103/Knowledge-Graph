...
# 微调模型路径
FINETUNED_MODEL_PATH = os.path.join(MODEL_DIR, 'ner_finetuned_config_4_traindata_ccks')
...
# Runtime overrides for local execution.
ES_MODE = os.getenv("KG_WORK_WYY_ES_MODE", os.getenv("KG_ES_MODE", ES_MODE))
ES_LOCAL_CONFIG = dict(ES_LOCAL_CONFIG)
ES_LOCAL_CONFIG["url"] = os.getenv("KG_ES_URL", ES_LOCAL_CONFIG["url"])
ES_LOCAL_CONFIG["request_timeout"] = int(
    os.getenv("KG_ES_REQUEST_TIMEOUT", str(ES_LOCAL_CONFIG["request_timeout"]))
)
if os.getenv("KG_WORK_WYY_BASE_MODEL_PATH"):
    BASE_MODEL_PATH = os.path.abspath(os.getenv("KG_WORK_WYY_BASE_MODEL_PATH", BASE_MODEL_PATH))
if os.getenv("KG_WORK_WYY_TRAIN_TXT_FILE"):
    TRAIN_TXT_FILE = os.path.abspath(os.getenv("KG_WORK_WYY_TRAIN_TXT_FILE", TRAIN_TXT_FILE))
if os.getenv("KG_WORK_WYY_CCKS_NER_DIR"):
    CCKS_NER_DIR = os.path.abspath(os.getenv("KG_WORK_WYY_CCKS_NER_DIR", CCKS_NER_DIR))
if os.getenv("KG_WORK_WYY_MSRA_DIR"):
    MSRA_DIR = os.path.abspath(os.getenv("KG_WORK_WYY_MSRA_DIR", MSRA_DIR))
if os.getenv("KG_WORK_WYY_ES_INDEX_NAME"):
    ES_INDEX_NAME = os.getenv("KG_WORK_WYY_ES_INDEX_NAME", ES_INDEX_NAME)
ZHIPUAI_API_KEY = os.getenv("KG_ZHIPU_API_KEY") or os.getenv("ZHIPUAI_API_KEY") or ZHIPUAI_API_KEY
