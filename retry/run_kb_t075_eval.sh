...
export KG_ES_INDEX_NAME=data2_enriched_kb_t075_zhonly
export KG_EVAL_STATE_FILE="D:/work/毕设/知识图谱/Knowledge-Graph/retry/output/work_wyy_enriched_kb_t075_eval_state.json"
...
echo "[$(date -Iseconds)] ALL 5 MODES COMPLETE"
